  ...
  const characterList = [
    {
      ...
      avatar: '/main-characters/Ahmad.jpeg',
    },
    {
      name: 'Sarah',
      ...
      avatar: '/main-characters/Sarah.jpeg',
    },
    {
      name: 'Ily',
      age: '13 ' + (lang === 'fr' ? 'ans' : 'y/o'),
      ...
      avatar: '/main-characters/Ily.jpeg',
    },
    {
      name: 'Yusuf',
      ...
      color: 'border-terracotta text-terracotta',
      avatar: '/main-characters/Yusuf.jpeg',
    },
    {
      name: 'Junior',
      ...
      color: 'border-deep-green text-deep-green',
      avatar: '/main-characters/Junior.jpeg',
    },
    {
      ...
      color: 'border-gold text-gold',
      avatar: '/main-characters/Inpectrice Famille.jpeg',
    }
  ];
    ...
    <div className="relative overflow-hidden min-h-screen">
      ...
      <section className="max-w-6xl mx-auto px-6 mb-24">
        <div className="relative aspect-video rounded-3xl overflow-hidden shadow-2xl border border-[var(--color-border)] group">
          <img
            src="/assets/projects/gardiens-hero.jpg"
